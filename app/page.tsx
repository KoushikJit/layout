...
let autoRecordEnabledVar = false;
let volume = 0.8;
let timeOutVar = null;
...
const Home: React.FC = () => {
    ...
    useEffect(() => {
      autoRecordEnabledVar = autoRecordEnabled;
      volume = volumeState;
    }, [autoRecordEnabled, volumeState])
        ...
        if (model &&
            ...
            if (predictions?.length > 0) {
                ...
                predictions.forEach(prediction => {
                    ...
                    person && drawPredictionOnCanvas(prediction, canvasRef.current?.getContext("2d"));
                });
                if (person && autoRecordEnabledVar) {
                    startRecording(true);
                }
            }
        }
